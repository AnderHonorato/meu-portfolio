...
def nav():
    return '''<header class="id-nav"><a class="id-brand" href="../index.html"><img src="assets/anderflow-logo-original.png" alt="">ANDERFLOW</a><span class="id-nav-note">identidade · digital · matéria</span><nav class="id-nav-links"><a href="../portfolio.html">Portfólio</a><a href="identidades.html">Identidades</a><a href="../contato.html">Contato</a></nav></header>'''


def footer():
    return '''<footer class="id-footer"><a href="../index.html">anderflow</a><span>Identidade autoral para marcas que não querem parecer genéricas.</span><span>© 2026 · Anderson Honorato</span></footer><nav class="id-bottom"><a href="identidades.html"><span>00</span>Índice</a><a href="../portfolio.html"><span>01</span>Portfólio</a><a href="../contato.html"><span>→</span>Contato</a></nav>'''
